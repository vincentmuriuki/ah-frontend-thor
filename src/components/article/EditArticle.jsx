              ...
              <div className="text-center">
                <div className="form-group shadow-textarea">
                  {this.formInputHelper(
                    ...
                    this.onChange,
                    title,
                    "form-control font-weight-bold no-border in-font",
                    null
                  )}
                  {this.formInputHelper(
                    "textInput",
                    ...
                    this.onChange,
                    description,
                    "form-control font-weight-bold no-border",
                    null
                  )}
                  {this.formInputHelper(
                    "textArea",
                    ...
                    this.onChange,
                    body,
                    "form-control z-depth-1 no-border in-fontt",
                    "20"
                  )}
                  {this.formOnClickHelper(
                    "Choose Article Image Url(Optional)",
                    "imageUrl",
                    "text",
                    this.handleOnClick,
                    imageUrl,
                  ...
                  {this.formAudioInputHelper(
                    "textInputAudio",
                    "Article Audio Url(Optional)",
                    "audioUrl",
                    "text",
                    this.onChange,
                    audioUrl,
