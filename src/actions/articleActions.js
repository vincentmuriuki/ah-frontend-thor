...
import { POST_ARTICLE, PROFILE_ARTICLES, GET_ARTICLE_BY_ID, UPDATE_ARTICLE } from "./types";
...
const getAuthorArticles = () => dispatch => {
  ...
  return fetch(`https://ah-backend-thor.herokuapp.com/api/articles/?author_name=${user}`)
    .then(res => res.json())
